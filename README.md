...
![quick install for non-readers](https://img.shields.io/badge/%E2%9A%A1_quick_install_for_non--readers-d7875f?style=for-the-badge) `curl -fsSL https://pivotal.obaid.wtf/install.sh | bash`
